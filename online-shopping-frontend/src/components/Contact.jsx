...
const Contact = () => {
    return(
        <div
            ...
            style={{backgroundImage: "url('https://images.pexels.com/photos/26268380/pexels-photo-26268380.jpeg?_gl=1*1ykw09s*_ga*ODg3NjU0MzA1LjE3NzY0NDI1NTI.*_ga_8JE65Q40S6*czE3NzY0NDI1NTEkbzEkZzEkdDE3NzY0NDQ3ODAkajQwJGwwJGgw')"}}>
